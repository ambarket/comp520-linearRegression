...
\begin{thebibliography}{100} % 100 is a random guess of the total number of
	...
	\bibitem[1]{powerPlantDataset} ``Combined Cycle Power Plant Data Set," http://archive.ics.uci.edu/ml/datasets/Combined+Cycle+Power+Plant
	\bibitem[2]{powerPlantCiteRequest1} Goossens, M., Mittelbach, F., Samarin, \emph{A LaTeX
		Companion}, Addison-Wesley, Reading, MA, 1994.
	\bibitem[3]{powerPlantCiteRequest2} Kopka, H., Daly P.W., \emph{A Guide to LaTeX},
	Addison-Wesley, Reading, MA, 1999.
	\bibitem[4]{Pan} Pan, D., ``A Tutorial on MPEG/Audio Compression,"
